Tea.context(function () {
	...
	if (this.set.actionOptions != null && typeof (this.set.actionOptions.groupId) == "string") {
		this.actionGroupId = this.set.actionOptions.groupId;

		if (typeof (this.set.actionOptions.setId) == "string") {
			this.actionSetId = this.set.actionOptions.setId;
		}
	} else if (this.config.inbound.length > 0) {
