Tea.context(function () {
     ...
     * 状态码相关
     */
    this.supportAllStatus = this.header.always;
    if (this.header.always) {
        this.statusList = (this.header.status != null && this.header.status.length > 0) ? this.header.status : [200, 201, 204, 206, 301, 302, 303, 304, 307, 308];
    } else {
        this.statusList = (this.header.status != null) ? this.header.status : [];
    }
